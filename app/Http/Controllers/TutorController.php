    ...
    public function addSession(Request $request, $user_id)
    {
        ...
        $session = TutorSession::updateorCreate([
            ...
            'session_day' => json_encode([
                'monday' => $session_day['monday'] ?? false,
                'tuesday' => $session_day['tuesday'] ?? false,
                'wednesday' => $session_day['wednesday'] ?? false,
                'thursday' => $session_day['thursday'] ?? false,
                'friday' => $session_day['friday'] ?? false,
                'saturday' => $session_day['saturday'] ?? false,
                'sunday' => $session_day['sunday'] ?? false,
            ]),
